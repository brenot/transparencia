...
;(function (t) {
    t.widget('ui.draggable', t.ui.mouse, {
        ...
        cancel: function () {
            return (
                this.helper.is('.ui-draggable-dragging') ? this._mouseUp({}) : this._clear(), this
            )
        },
        ...
        _create: function () {
            ...
            if (
                ...
                t.extend(this, {
                    ...
                    _helper:
                        r.helper || r.ghost || r.animate ? r.helper || 'ui-resizable-helper' : null,
                }),
            ...
            resize: function (e) {
                ...
                d[0] !== document && /static/.test(d.css('position')) && (u = h),
                    l.left < (o._helper ? h.left : 0) &&
                        ((o.size.width =
                            o.size.width +
                            (o._helper ? o.position.left - h.left : o.position.left - u.left)),
        ...
        serialize: function (e) {
            ...
            return (
                ...
                t(i).each(function () {
                    ...
                    i &&
                        s.push((e.key || i[1] + '[]') + '=' + (e.key && e.expression ? i[1] : i[2]))
                }),
...
;(function (e) {
    ...
    e.widget('ui.button', {
        ...
        _create: function () {
            ...
            null === o.label &&
                (o.label =
                    'input' === this.type ? this.buttonElement.val() : this.buttonElement.html()),
        ...
        _resetButton: function () {
            ...
            s.primary || s.secondary
                ? (this.options.text &&
                      o.push(
                          'ui-button-text-icon' + (a ? 's' : s.primary ? '-primary' : '-secondary'),
                      ),
                  s.primary &&
                      t.prepend(
            ...
            return c.disabled
                ...
                : ((this.elementSize = {
                  ...
                  this.handles.each(function (e) {
                      ...
                      ;(n > i ||
                          (n === i && (e === u._lastChangedValue || u.values(e) === c.min))) &&
                          ((n = i), (a = t(this)), (o = e))
                  }),
                  (r = this._start(e, o)),
                  r === !1
        ...
        _refreshValue: function () {
            ...
            this.options.values && this.options.values.length
                ? this.handles.each(function (s) {
                      ;(i =
                          100 * ((l.values(s) - l._valueMin()) / (l._valueMax() - l._valueMin()))),
        ...
        _tabKeydown: function (i) {
            ...
            if (!this._handlePageNav(i)) {
                switch (i.keyCode) {
                    ...
                    case t.ui.keyCode.SPACE:
                        return (
                            i.preventDefault(), clearTimeout(this.activating), this._activate(n), e
                        )
                    case t.ui.keyCode.ENTER:
                        return (
                            i.preventDefault(),
    ...
    ;(t.effects.effect.puff = function (e, i) {
        ...
        (t.effects.effect.scale = function (e, i) {
            ...
            ;(n.effect = 'size'),
                ...
                (n.from =
                    e.from ||
                    ('show' === a ? { height: 0, width: 0, outerHeight: 0, outerWidth: 0 } : h)),
                (n.to = {
                    height: h.height * c.y,
                    width: h.width * c.x,
