...
jQuery.fn.jGrid = function (options) {
    ...
    var jGrid = {
                ...
                for (var i = 0; i < limite; i++) {
                    ...
                    for (var k in opts.colluns) {
                        if (opts.colluns[y].hasLink) {
                            html +=
                                '<td class="' +
                                opts.colluns[y].classe_th +
                                '" style="width:' +
                                opts.colluns[y].width +
                                'px;"><div class="div_td" style="word-wrap: break-word; width:' +
                                opts.colluns[y].width +
                                'px;"><div class="acoes">'
                            for (var x in opts.colluns[y].links) {
                                var insertLink = true
                                if (
                                    opts.colluns[y].validacoes &&
                                    opts.colluns[y].validacoes[x] != null
                                ) {
                                ...
                                if (insertLink) {
                                    ...
                                    for (var j in opts.colluns[y].propertyName) {
                                        ...
                                        if (
                                            (link.indexOf('radio') >= 0 ||
                                                link.indexOf('checkbox') >= 0) &&
                                            j == 0
                                        ) {
                                    ...
                                    opts.colluns[y].linkDesabilitado &&
                                    opts.colluns[y].linkDesabilitado[x]
                                ) {
                            ...
                            var classLinha = opts.colluns[y].classe_div_linha
                                ? opts.colluns[y].classe_div_linha
                                : 'div_td'
                            html +=
                                '<td id=' +
                                y +
            ...
            if (limite > 0) {
                for (var i = 0; i < limite; i++) {
                    if (limite > 0) {
                        ...
                        if (
                            response.Lista[i]['NmArquivoDestaque'] != null &&
                            response.Lista[i]['NmArquivoDestaque'] != '' &&
                            response.Lista[i]['NmArquivoDestaque'] != 'null'
                        ) {
                            ...
                            html +=
                                ' <a href="' +
                                rootUrl +
                                response.Lista[i]['NmLink'] +
                                '" title="Foto da publicação ' +
                                response.Lista[i]['NmTitulo'] +
                                '"><img src="' +
                                response.Lista[i]['NmArquivoDestaque'] +
                                '" width="210" height="120" alt="Foto da publicação ' +
                                response.Lista[i]['NmTitulo'] +
                                '" title="Foto da publicação ' +
                                htmlEncode(response.Lista[i]['NmTitulo']) +
                                '"></a>'
                            html += '</div>'
                        }
                        ...
                        if (response.Lista[i]['DhDataItemFormatada'] != '')
                            dhDataItemFormatada =
                                ...
                                response.Lista[i]['DhDataItemFormatada'] +
                                '&nbsp;-&nbsp;</span>'

                        html +=
                            '<div class="subtitulo">' +
                            dhDataItemFormatada +
                            response.Lista[i]['NmTipoRegistro'] +
                            '</div>'
                        html +=
                            '<h1><a href="' +
                            rootUrl +
        ...
        montaTbodyVideos: function (response) {
            ...
            if (limite > 0) {
                ...
                jQuery(isto).html(
                    '<div class="lista margin_bottom_25">' + opts.miExcessao + '</div>',
                )
            }
        },
        montaTbodyAudio: function (response) {
            ...
            if (limite > 0) {
                for (var i = 0; i < limite; i++) {
                    if (limite > 0) {
                        html +=
                            '<div class="lista sem_imagem margin_bottom_25"><div class="conteudo">'
                        html +=
                            '<div class="subtitulo">' +
                            response.Lista[i]['DataHoraPublicacao'] +
                            '<span>Por ' +
                            htmlEncode(response.Lista[i]['NmCredito']) +
                            '</span></div>'
                        html +=
                            '<h1><a href="javascript: return false;" title="' +
                            response.Lista[i]['NmTitulo'] +
                            '">' +
                            htmlEncode(response.Lista[i]['NmTitulo']) +
                            '</a></h1>'
                        ...
                        // <!-- PLAYER -->
                        html +=
                            '<div id="audio_' + i + '" class="jquery_jplayer_1 jp-jplayer"></div>'
                        html +=
                        ...
                        html +=
                            '   <li><a href="javascript:;" class="jp-mute" tabindex="1" title="Sem Áudio">Sem Áudio</a></li>'
                        html +=
                            '   <li><a href="javascript:;" class="jp-unmute" tabindex="1" title="Reativar Áudio">Reativar Áudio</a></li>'
                        html +=
                            '   <li><a href="javascript:;" class="jp-volume-max" tabindex="1" title="Volume Máximo">Volume Máximo</a></li>'
                        html += '             </ul>'
                ...
                for (var i = 0; i < limite; i++) {
                    if (limite > 0) {
                        ...
                        html +=
                            ...
                            response.Lista[i]['NmTitulo'] +
                            '">' +
                            htmlEncode(response.Lista[i]['NmTitulo'].toUpperCase()) +
                            '</a></h2>'
                        html += '<p>' + htmlEncode(response.Lista[i]['NmDescricao']) + '</p>'
                        html += '<div class="imagens image-set">'
                        var qtd =
                            response.Lista[i]['ListaFotos'].length > 6
                                ? 6
                                : response.Lista[i]['ListaFotos'].length
                        for (var j = 0; j < qtd; j++) {
                            var credito =
                                response.Lista[i]['ListaFotos'][j]['DataFormatadaParaSite']
                            var legenda = ''
                            ...
                            if (response.Lista[i]['ListaFotos'][j]['NmCredito'] != null) {
                                credito +=
                                    ' | Por ' + response.Lista[i]['ListaFotos'][j]['NmCredito']
                            }
                            html += '<a creditos="' + credito + '" legendaImagem="' + legenda + '">'
                            html +=
                                '<img class="margem-imagens-tour" src="' +
                                response.Lista[i]['CaminhoBase'] +
                                'pequena_' +
                                response.Lista[i]['ListaFotos'][j]['NmArquivo'] +
        ...
        montaTbodyNoticia: function (response) {
            ...
            if (limite > 0) {
                for (var i = 0; i < limite; i++) {
                    if (limite > 0) {
                        if (
                            response.Lista[i]['NmCaminhoImagem'] != null &&
                            response.Lista[i]['NmCaminhoImagem'] != '' &&
                            response.Lista[i]['NmCaminhoImagem'] != 'null'
                        ) {
                            html += '<div class="lista margin_bottom_25">'
                            html +=
                                '<div class="imagem"><a href="' +
                                rootUrl +
                                response.Lista[i]['NmLink'] +
                                '" title="Foto da notícia ' +
                                response.Lista[i]['NmTitulo'] +
                                '">'
                            html +=
                                '<img src="' +
                                response.Lista[i]['NmCaminhoImagem'] +
                                '" width="210" height="120" alt="Foto da notícia ' +
                                response.Lista[i]['NmTitulo'] +
                                '" title="Foto da notícia ' +
                                response.Lista[i]['NmTitulo'] +
                                '"></a></div>'
                        ...
                        html += ' <div class="conteudo">'
                        var credito =
                            response.Lista[i]['NmCredito'] != null &&
                            response.Lista[i]['NmCredito'] != 'null'
                                ? 'Por ' + htmlEncode(response.Lista[i]['NmCredito'])
                                : ''
                        html +=
                            ' <div class="subtitulo">' +
                            response.Lista[i]['DataHoraPublicacao'] +
        ...
        montaTBodyDocumentoEletronico: function (response) {
            ...
            if (limite > 0) {
                for (var i = 0; i < limite; i++) {
                    if (limite > 0) {
                        var link =
                            "javascript:DownloadArquivo('" +
                            response.Lista[i]['NmLinkDownload'] +
                            "','DO')"
                        html += '<div class="lista jornal margin_bottom_25">'
                        html +=
                            '<div class="capa"><a title="' +
                            htmlEncode(response.Lista[i]['NmTitulo']) +
                            '"><img src="' +
                            response.Lista[i]['NmCaminhoBase'] +
                            response.Lista[i]['NmCaminhoImagem'] +
                            '" width="85" height="120"></a></div>'
                        html +=
                            '<div class="conteudo"><div class="subtitulo">' +
                            response.Lista[i]['DataHoraPublicacao'] +
                            '</div>'
                        ...
                        if (response.Lista[i]['NmCaminhoAudio'] != '') {
                            html +=
                                '<div id="audio_' +
                                i +
                                '" class="jquery_jplayer_1 jp-jplayer"></div>'
                            html +=
                                '<div id="jp_container_' +
                                i +
                                '" class="jp_container_' +
                            ...
                            html +=
                                '  <div class="jp-volume-bar"> <div class="jp-volume-bar-value"></div>  </div></div>'
                            html +=
                        ...
                        html +=
                            '<a href="' +
                            link +
                            '" class="link margin_bottom_25" title="' +
                            response.Lista[i]['NmTitulo'] +
                            '">' +
                            htmlEncode(response.Lista[i]['NmTitulo']) +
                            '</a>'
            ...
            if (limite > 0) {
                for (var i = 0; i < limite; i++) {
                    if (limite > 0) {
                        ...
                        html += '<p>' + response.Lista[i]['NmDescricao'] + '</p>'
                        html +=
                            '<a href="' + rootUrl + response.Lista[i]['NmLink'] + '">CONTINUAR</a>'
                        html += '</div>'
            ...
            if (limite > 0) {
                for (var i = 0; i < limite; i++) {
                    if (limite > 0) {
                        ...
                        var onclickTitulo =
                            rootUrl + 'Blog/Index?url=' + response.Lista[i]['UrlHiperlink']
                        // var onclickTitulo = "window.open('" + response.Lista[i]["UrlHiperlink"] + "', '_blank')";

                        if (
                            response.Lista[i]['NmDescricaoUltimoPost'] != null &&
                            response.Lista[i]['NmDescricaoUltimoPost'] != '' &&
                            response.Lista[i]['NmLink'] != ''
                        ) {
                            var onclick =
                                rootUrl + 'Blog/Index?url=' + response.Lista[i]['UrlHiperlink']
                        ...
                        html +=
                            '<h1 class="margin_bottom_0"><a href="' +
                            onclickTitulo +
                            '" title="' +
                            htmlEncode(response.Lista[i]['NmTitulo']) +
                            '"> ' +
                            ...
                            '</a></h1>'
                        html +=
                            '<div class="subtitulo margin_bottom_10">' +
                            htmlEncode(response.Lista[i]['NmDescricao']) +
                            '</div>'
                        if (
                            response.Lista[i]['NmChaveBlog'] != null &&
                            response.Lista[i]['NmChaveBlog'] != '' &&
                            response.Lista[i]['NmCodigoBlog'] != null &&
                            response.Lista[i]['NmCodigoBlog'] != ''
                        ) {
                            if (response.Lista[i]['NmDescricaoUltimoPost'] != null) {
                                html +=
                                    '<p style="font-size:10px;"><strong>ÚLTIMO POST:' +
                                    response.Lista[i]['DataUltimaPublicacao'] +
                                    ' - ' +
                                    response.Lista[i]['HoraUltimaPublicacao'] +
                                    '</strong></p>'

                                var re = /(<([^>]+)>)/gi
                                response.Lista[i]['NmDescricaoUltimoPost'] = response.Lista[i][
                                    'NmDescricaoUltimoPost'
                                ].replace(re, '')

                                if (response.Lista[i]['NmDescricaoUltimoPost'].length > 250) {
                                    html +=
                                        '<p class="margin_bottom_5">' +
                                        response.Lista[i]['NmDescricaoUltimoPost'].substring(
                                            0,
                                            247,
                                        ) +
                                        '...</p>'
                        ...
                        if (onclick != '') {
                            html +=
                                '<a  href="' +
                                onclick +
                                '" class="link margin_bottom_5">VISUALIZAR...</a>'
                        }
                        html += '</div>'
                        html += '</div>'
        ...
        __montaPaginacao_1: function (response, paginaAtual, limite) {
            if (response.Total > 0) {
                ...
                regFim =
                    paginaAtual * opts.limite > response.Total
                        ? response.Total
                        : paginaAtual * opts.limite

                html += '<div id="j-grid-paginacao">'
                if (totalPage > 1) {
                    html +=
                        '<div class="exibindo">Exibindo ' +
                        regIni +
                        ' a ' +
                        regFim +
                        ' de ' +
                ...
                if (totalPage > 1) {
                    if (paginaAtual == 1) {
                        html +=
                            '<div class="icone"><a id="j-grid-inicio" href="javascript:return false;" title="Primeira" class="primeira desativado"></a></div>'
                        html +=
                            '<div class="icone"><a id="j-grid-aterior" href="javascript:return false;" title="Anterior" class="anterior desativado"></a></div>'
                    } else {
                        html +=
                            '<div class="icone"><a id="j-grid-inicio" href="javascript:return false;" title="Primeira" class="primeira j-grid-inicio"></a></div>'
                        html +=
                            '<div class="icone"><a id="j-grid-aterior" href="javascript:return false;" title="Anterior" class="anterior j-grid-aterior"></a></div>'
                    }

                    for (var i = iniPage; i < numPage; i++) {
                        if (i != paginaAtual) {
                            html +=
                                '<div class="botao"><a href="javascript:return false;" class="j-grid-paginas" title="' +
                                i +
                                '">' +
                                i +
                                '</a></div>'
                            ...
                            html +=
                                '<div class="botao"><a href="javascript:return false;" title="' +
                                i +
                                '" class="ativo j-grid-paginas">' +
                                i +
                                '</a></div>'
                        }
                    }
                    ...
                    if (paginaAtual == totalPage || totalPage == '0') {
                        html +=
                            '<div class="icone"><a id="j-grid-proximo" href="javascript:return false;" title="Próxima" class="proxima desativado"></a></div>'
                        html +=
                            '<div class="icone"><a id="j-grid-fim" href="javascript:return false;" title="Última" class="ultima desativado"></a></div>'
                    } else {
                        html +=
                            '<div class="icone"><a id="j-grid-proximo" href="javascript:return false;" title="Próxima" class="proxima j-grid-proximo"></a></div>'
                        html +=
                            '<div class="icone"><a id="j-grid-fim" href="javascript:return false;" title="Última" class="icone ultima j-grid-fim"></a></div>'
                    }
                }
                //   html += '</ul>';
                ...
                $(isto)
                    .parent()
                    .parent()
                    .find('.borda_inferior, .borda_superior')
                    .find('#j-grid-paginacao')
                    .remove()
        ...
        __montaPaginacao_2: function (response, paginaAtual, limite) {
            ...
            if (totalPage > 1) {
                if (paginaAtual == 1) {
                    ...
                    html +=
                        '<div class="botao margin_left_5"><a id="j-grid-inicio" href="javascript:;">&lt;&lt;</a></div>'
                    html +=
                        '<div class="botao margin_left_5"><a id="j-grid-aterior" href="javascript:;">&lt;</a></div>'
                }

                for (var i = iniPage; i < numPage; i++) {
                    if (i != paginaAtual) {
                        html +=
                            '<div class="botao margin_left_5" ><a class="j-grid-paginas" href="javascript:;">' +
                            i +
                            '</a></div>'
                    } else {
                ...
                if (paginaAtual == totalPage || totalPage == '0') {
                    ...
                    html +=
                        '<div class="botao margin_left_5"><a id="j-grid-proximo" href="javascript:;">&gt;</a></div>'
                    html +=
                        '<div class="botao margin_left_5"><a id="j-grid-fim" href="javascript:;">&gt;&gt;</a></div>'
                }
            }
            html += '</div>'
            html += '</div>'
        ...
        __montaPaginacao_3: function (response, paginaAtual, limite) {
            ...
            html +=
                '<div class="base fundo_02" id="j-grid-paginacao" style="min-height: 24px; display:none;">'
            html += '<div class="paginacao">'
        ...
        __detectOrder: function (data, cache) {
            ...
            if (data && data.order) {
                ...
                order =
                    orderUrl[0] == data.order && orderUrl[1] == 'ASC'
                        ? data.order + ' DESC'
                        : data.order + ' ASC'
            } else {
            ...
            jQuery(isto)
                .find('.j-grid-order-asc, .j-grid-order-desc')
                .removeClass('j-grid-order-asc j-grid-order-desc ativo')

            var orderNow = order.split(' ')
            if (orderNow[1] == 'ASC') {
                //img asc
                jQuery(isto)
                    .find('#j-grid-order-' + orderNow[0] + '')
                    .addClass('j-grid-order-asc ativo')
            } else {
                //img des
                jQuery(isto)
                    .find('#j-grid-order-' + orderNow[0] + '')
                    .addClass('j-grid-order-desc ativo')
            }
    ...
    html +=
        '<table id="j-grid-table" class="table table-hover table-striped" width="' +
        opts.width +
        '" style="' +
        opts.style +
    ...
    if (opts.collunsPai.length > 0) {
        for (var i in opts.collunsPai) {
            classe = opts.collunsPai[i].classe_th
                ? 'class="' + opts.collunsPai[i].classe_th + '"'
                : ''
            classe_div = opts.collunsPai[i].classe_div
                ? 'class="' + opts.collunsPai[i].classe_div + '"'
                : ''
            ...
            html +=
                ...
                classe +
                ' width="' +
                opts.collunsPai[i].width +
                '" ' +
                height +
                ' colspan="' +
                opts.collunsPai[i].colspan +
                '"><div ' +
                classe_div +
                ' style="width:' +
                opts.collunsPai[i].width +
                'px;">' +
                opts.collunsPai[i].header +
                '</div></th>'
        }
        count_ordem = 0
...
jQuery.fn.jGrid.defaults = {
    ...
    complete: false,
    miExcessao:
        "<div class='mensagem erro margin_top_20 margin_bottom_10'>Resultado não encontrado.</div>",
