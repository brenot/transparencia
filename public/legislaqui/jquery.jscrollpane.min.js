        ...
        function e(d, e) {
                ...
                Q.css('overflow', 'auto'),
                    ...
                    Z || Y
                        ? (d.addClass('jspScrollable'),
                          ...
                          P.clickOnTrack && o(),
                          L(),
                          P.hijackInternalLinks && M())
                        : (d.removeClass('jspScrollable'),
                          Q.css({ top: 0, left: 0, width: T.width() - tb }),
                          F(),
                          I(),
                          K(),
                          p()),
                    P.autoReinitialise && !rb
                        ? (rb = setInterval(function () {
                              f(P)
                          }, P.autoReinitialiseDelay))
                        : !P.autoReinitialise && rb && clearInterval(rb),
                ...
                Y &&
                    (T.append(
                        a('<div class="jspVerticalBar" />').append(
                            ...
                            a('<div class="jspTrack" />').append(
                                a('<div class="jspDrag" />').append(
                    ...
                    ($ = fb.find('>.jspDrag')),
                    P.showArrows &&
                        ((jb = a('<a class="jspArrow jspArrowUp" />')
                            .bind('mousedown.jsp', m(0, -1))
                            .bind('click.jsp', G)),
                        (kb = a('<a class="jspArrow jspArrowDown" />')
                            .bind('mousedown.jsp', m(0, 1))
                            .bind('click.jsp', G)),
                        P.arrowScrollOnHover &&
                            (jb.bind('mouseover.jsp', m(0, -1, jb)),
                            kb.bind('mouseover.jsp', m(0, 1, kb))),
                        l(fb, P.verticalArrowPositions, jb, kb)),
                    (hb = S),
                    T.find('>.jspVerticalBar>.jspCap:visible,>.jspVerticalBar>.jspArrow').each(
                        function () {
            ...
            function i() {
                Z &&
                    ...
                    (bb = mb.find('>.jspDrag')),
                    P.showArrows &&
                        ((pb = a('<a class="jspArrow jspArrowLeft" />')
                            .bind('mousedown.jsp', m(-1, 0))
                            .bind('click.jsp', G)),
                        (qb = a('<a class="jspArrow jspArrowRight" />')
                            .bind('mousedown.jsp', m(1, 0))
                            .bind('click.jsp', G)),
                        P.arrowScrollOnHover &&
                            (pb.bind('mouseover.jsp', m(-1, 0, pb)),
            ...
            function j() {
                T.find('>.jspHorizontalBar>.jspCap:visible,>.jspHorizontalBar>.jspArrow').each(
                    function () {
            ...
            function k() {
                ...
                Z && Q.width(T.outerWidth() - tb + 'px'),
                    ...
                    Z &&
                        ((ob = Math.ceil((1 / W) * nb)),
                        ob > P.horizontalDragMaxWidth
                            ? (ob = P.horizontalDragMaxWidth)
                            : ob < P.horizontalDragMinWidth && (ob = P.horizontalDragMinWidth),
                        bb.width(ob + 'px'),
                        (cb = nb - ob),
                        u(db)),
                    Y &&
                        ((ib = Math.ceil((1 / X) * hb)),
                        ib > P.verticalDragMaxHeight
                            ? (ib = P.verticalDragMaxHeight)
                            : ib < P.verticalDragMinHeight && (ib = P.verticalDragMinHeight),
                        $.height(ib + 'px'),
                        (_ = hb - ib),
                        s(ab))
            }
            ...
            function o() {
                p(),
                    Y &&
                        fb.bind('mousedown.jsp', function (b) {
                            if (b.originalTarget === c || b.originalTarget == b.currentTarget) {
                                var d,
                                    ...
                                    i = function () {
                                        ...
                                        ;(d = setTimeout(
                                            i,
                                            h ? P.initialDelay : P.trackClickRepeatFreq,
                                        )),
                                            (h = !1)
                                    },
                                    j = function () {
                    ...
                    Z &&
                        mb.bind('mousedown.jsp', function (b) {
                            if (b.originalTarget === c || b.originalTarget == b.currentTarget) {
                                var d,
                                    e = a(this),
                                    f = e.offset(),
            ...
            function r(a, b) {
                Y &&
                    ...
                    b ? vb.animate($, 'top', a, s) : ($.css('top', a), s(a)))
            }
            function s(a) {
                ...
                var b = 0 === ab,
                    ...
                    g = -f * (V - S)
                ;(wb != b || yb != e) &&
                    ((wb = b), (yb = e), d.trigger('jsp-arrow-change', [wb, yb, xb, zb])),
                    v(b, e),
                    Q.css('top', g),
            ...
            function t(a, b) {
                Z &&
                    (0 > a ? (a = 0) : a > cb && (a = cb),
                    b === c && (b = P.animateScroll),
                    b ? vb.animate(bb, 'left', a, u) : (bb.css('left', a), u(a)))
            }
            function u(a) {
                ...
                var b = 0 === db,
                    ...
                    g = -f * (U - R)
                ;(xb != b || zb != e) &&
                    ((xb = b), (zb = e), d.trigger('jsp-arrow-change', [wb, yb, xb, zb])),
                    w(b, e),
                    Q.css('left', g),
            ...
            function v(a, b) {
                P.showArrows &&
                    (jb[a ? 'addClass' : 'removeClass']('jspDisabled'),
                    kb[b ? 'addClass' : 'removeClass']('jspDisabled'))
            }
            function w(a, b) {
                P.showArrows &&
                    (pb[a ? 'addClass' : 'removeClass']('jspDisabled'),
            ...
            function z(b, c, d) {
                ...
                for (
                    f = e.outerHeight(), g = e.outerWidth(), T.scrollTop(0), T.scrollLeft(0);
                    !e.is('.jspPane');
                ...
                ;(h = B()),
                    (j = h + S),
                    h > n || c
                        ? (l = n - P.horizontalGutter)
                        : n + f > j && (l = n - S + f + P.horizontalGutter),
                    isNaN(l) || x(l, d),
                    (i = A()),
                    (k = i + R),
                    i > o || c
                        ? (m = o - P.horizontalGutter)
                        : o + g > k && (m = o - R + g + P.horizontalGutter),
                    isNaN(m) || y(m, d)
            }
            function A() {
            ...
            function J() {
                ...
                Z && f.push(lb[0]),
                    ...
                    P.hideFocus
                        ? (d.css('outline', 'none'), 'hideFocus' in T[0] && d.attr('hideFocus', !0))
                        : (d.css('outline', ''), 'hideFocus' in T[0] && d.attr('hideFocus', !1))
            }
            function K() {
                ...
                if (location.hash && location.hash.length > 1) {
                    ...
                    b.length &&
                        ...
                        (0 === T.scrollTop()
                            ...
                            : (z(b, !0), a(document).scrollTop(T.position().top)))
                }
            }
            function M() {
                    ...
                    .bind('touchmove.jsp', function (g) {
                        if (f) {
                            var h = g.originalEvent.touches[0],
                                ...
                                j = ab
                            return (
                                vb.scrollTo(a + c - h.pageX, b + d - h.pageY),
