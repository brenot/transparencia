...
;(function ($, undefined) {
    ...
    $.fn.cycle = function (options, arg2) {
        ...
        return this.each(function () {
            ...
            var startTime = opts2.continuous
                ? 10
                : getTimeout(els[opts2.currSlide], els[opts2.nextSlide], opts2, !opts2.backwards)
    ...
    function buildOptions($cont, $slides, els, options, o) {
        ...
        if (opts.fit) {
            if (!opts.aspect) {
                ...
                $slides.each(function () {
                    var $slide = $(this)
                    var ratio =
                        opts.aspect === true ? $slide.width() / $slide.height() : opts.aspect
        ...
        // stretch container
        var reshape =
            (opts.containerResize || opts.containerResizeHeight) && $cont.innerHeight() < 1
        if (reshape) {
