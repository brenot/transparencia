    ...
    ;(function ($, window, undefined) {
        ...
        $.extend($.mobile, {
            ...
            loading: function () {
                ...
                var loader =
                        this.loading._widget || $($.mobile.loader.prototype.defaultHtml).loader(),
    ...
    ;(function ($, window, undefined) {
        ...
        var str_hashchange = 'hashchange',
            ...
            supports_onhashchange =
                'on' + str_hashchange in window && (doc_mode === undefined || doc_mode > 7)
    ...
    ;(function ($, undefined) {
        ...
        $.mobile.path = path = {
            ...
            isExternal: function (url) {
                ...
                return !!(
                    u.protocol && u.domain.toLowerCase() !== this.documentUrl.domain.toLowerCase()
                )
            },
            ...
            isFirstPageUrl: function (url) {
                ...
                return (
                    samePath &&
                    (!u.hash || u.hash === '#' || (fpId && u.hash.replace(/^#/, '') === fpId))
                )
            },
        ...
        var baseElement = $('head').children('base'),
            ...
            base = {
                ...
                element: baseElement.length
                    ? baseElement
                    : $('<base>', { href: $.mobile.path.documentBase.hrefNoHash }).prependTo(
                          $('head'),
                      ),
    ...
    ;(function ($, undefined) {
        $.widget('mobile.pagecontainer', {
            ...
            _parse: function (html, fileUrl) {
                ...
                page.attr('data-' + this._getNs() + 'url', this._createDataUrl(fileUrl)).attr(
            ...
            _loadSuccess: function (absUrl, triggerData, settings, deferred) {
                ...
                return $.proxy(function (html, textStatus, xhr) {
                    ...
                    if (
                        this._triggerWithDeprecated('load', triggerData).event.isDefaultPrevented()
                    ) {
                        return
                    }
            ...
            load: function (url, options) {
                ...
                var deferred = (options && options.deferred) || $.Deferred(),
                    ...
                    reloadOptionExtension =
                        options && options.reload === undefined && options.reloadPage !== undefined
            ...
            transition: function (toPage, triggerData, settings) {
                ...
                url =
                    (settings.dataUrl && $.mobile.path.convertUrlToDataUrl(settings.dataUrl)) ||
                    toPage.jqmData('url')
            ...
            $.mobile.document.bind('vclick', function (event) {
                ...
                if ($.data(target, 'mobile-button')) {
                    ...
                    if (
                        !(
                            target &&
                            $.mobile.path.parseUrl(target.getAttribute('href') || '#').hash !== '#'
                        )
                    ) {
                        return
                    }
        ...
        $.widget('mobile.collapsible', {
            ...
            _enhance: function (elem, ui) {
                ...
                if (ui.heading.is('legend')) {
                    ...
                    ui.placeholder = $('<div><!-- placeholder for legend --></div>').insertBefore(
                        ui.originalHeading,
                    )
                ...
                if (
                    ...
                    if (hasIcon) {
                        anchor.addClass(
                            [
                                iconposClass(
                                    opts.iconpos !== undefined ? opts.iconpos : currentOpts.iconpos,
                                ),
                            ]
                                .concat(
                                    isCollapsed
            ...
            $.extend(
                {
                    ...
                    refresh: function (create) {
                        ...
                        for (pos = 0, numli = li.length; pos < numli; pos++) {
                            ...
                            if (
                                create ||
                                item[0].className.search(/\bui-li-static\b|\bui-li-divider\b/) < 0
                            ) {
            ...
            _setOptions: function (options) {
                ...
                if (
                    ...
                    outer
                        ...
                        .addClass(this._getIconClasses($.extend({}, this.options, options)))
                }
            ...
            $.extend(
                {
                    ...
                    _sliderVMouseDown: function (event) {
                        ...
                        if (
                            ...
                            !(event.which === 1 || event.which === 0 || event.which === undefined)
                        ) {
                            return false
                        }
                    ...
                    refresh: function (val, isfromControl, preventInputUpdate) {
                        ...
                        if (this._labels) {
                            ...
                            aPercent =
                                percent && handlePercent + ((100 - handlePercent) * percent) / 100
                            bPercent =
                                percent === 100 ? 0 : Math.min(handlePercent + 100 - aPercent, 100)
            ...
            $.extend(
                {
                    ...
                    refresh: function () {
                        var direction,
                            existingDirection = this.flipswitch.hasClass('ui-flipswitch-active')
                                ? '_right'
                                : '_left'
            ...
            $.extend(
                {
                    ...
                    _updateHighlight: function () {
                        var min = parseInt(
                                $.data(this._inputFirst.get(0), 'mobile-slider').handle.get(0).style
                                    .left,
                                10,
                            ),
                            max = parseInt(
                                $.data(this._inputLast.get(0), 'mobile-slider').handle.get(0).style
                                    .left,
                                10,
                            ),
                            width = max - min
        ...
        $.widget('mobile.popup', {
            ...
            _create: function () {
                ...
                currentOptions.history =
                    currentOptions.history && $.mobile.ajaxEnabled && $.mobile.hashListeningEnabled
			...
			*/
            ...
            open: function (options) {
                ...
                hasHash =
                    url.indexOf(hashkey) > -1 && !currentIsDialog && urlHistory.activeIndex > 0
    ...
    ;(function ($, undefined) {
        ...
        $.widget('mobile.selectmenu', $.mobile.selectmenu, {
            ...
            build: function () {
                ...
                header = $(
                    "<div class='ui-header ui-bar-" + (o.theme ? o.theme : 'inherit') + "'></div>",
                ).prependTo(listbox)
                ...
                if (o.trackPersistentToolbars) {
                    ...
                    nextFooter =
                        (thisFooter.length &&
                            ui.nextPage &&
                            $(
                                ".ui-footer-fixed:jqmData(id='" + thisFooter.jqmData('id') + "')",
                                ui.nextPage,
                            )) ||
                        $()
                    nextHeader =
                        (thisHeader.length &&
                            ui.nextPage &&
                            $(
                                ".ui-header-fixed:jqmData(id='" + thisHeader.jqmData('id') + "')",
                                ui.nextPage,
                            )) ||
                        $()
        ...
        $.widget('mobile.panel', {
            ...
            _destroy: function () {
                ...
                if (o.display !== 'overlay') {
                    ...
                    if (
                        otherPanels.not('.ui-panel-display-overlay').not(this.element).length === 0
                    ) {
                ...
                this.element
                    .removeClass(
                        [this._getPanelClasses(), o.classes.panelOpen, o.classes.animate].join(' '),
                    )
        ...
        $.widget('mobile.table', $.mobile.table, {
            ...
            _refresh: function (create) {
                ...
                if (!create && this.options.mode === 'columntoggle') {
                    ...
                    this._unlockCells(
                        this.element.find('.ui-table-cell-hidden, ' + '.ui-table-cell-visible'),
                    )
            ...
            _updateReflow: function () {
                ...
                $(table.allHeaders.get().reverse()).each(function () {
                    var cells = $(this).jqmData('cells'),
                        ...
                        hierarchyClass =
                            cells.not(this).filter('thead th').length && ' ui-table-cell-label-top',
    ...
    ;(function ($, undefined) {
        ...
        $.widget('mobile.filterable', $.mobile.filterable, {
            ...
            _handleCreate: function (evt) {
                this._setWidget(
                    this.element.data('mobile-' + evt.type.substring(0, evt.type.length - 6)),
                )
            },
            ...
            _isSearchInternal: function () {
                return (
                    this._search && this._search.jqmData('ui-filterable-' + this.uuid + '-internal')
                )
            },
            ...
            initializePage: function () {
                ...
                if (
                    ...
                    if (!$.event.special.navigate.isPushStateEnabled()) {
                        ...
                        $.mobile.navigate(
                            $.mobile.path.isPath(location.hash) ? location.hash : location.href,
                        )
                    }
                }
            },
