...
;(function (e) {
    ...
    ;(e.ui = e.ui || {}),
        ...
        (e.ui.plugin = {
            ...
            call: function (e, t, i, s) {
                ...
                if (
                    a &&
                    (s || (e.element[0].parentNode && 11 !== e.element[0].parentNode.nodeType))
                )
    ...
    e(document).mouseup(function () {
        ...
        e.widget('ui.sortable', e.ui.mouse, {
            ...
            refresh: function (e) {
                return (
                    this._refreshItems(e), this._setHandleClassName(), this.refreshPositions(), this
                )
            },
    ...
    e.widget('ui.button', {
        ...
        _resetButton: function () {
            ...
            s.primary || s.secondary
                ? (this.options.text &&
                      a.push(
                          'ui-button-text-icon' + (n ? 's' : s.primary ? '-primary' : '-secondary'),
                      ),
                  s.primary &&
                      t.prepend(
        ...
        e.widget('ui.selectmenu', {
            ...
            _drawButton: function () {
                ...
                ;(this.label = e("label[for='" + this.ids.element + "']").attr(
                    ...
                    e('<span>', { class: 'ui-icon ' + this.options.icons.button }).prependTo(
                        this.button,
                    ),
                ...
                return d.disabled
                    ...
                    : ((this.elementSize = {
                      ...
                      this.handles.each(function (t) {
                          ...
                          ;(n > i ||
                              (n === i && (t === u._lastChangedValue || u.values(t) === d.min))) &&
                              ((n = i), (a = e(this)), (o = t))
                      }),
                      (r = this._start(t, o)),
                      r === !1
        ...
        e.widget('ui.tabs', {
            ...
            _initialActive: function () {
                ...
                return (
                    ...
                    t !== !1 &&
                        ((t = this.tabs.index(this.tabs.eq(t))), -1 === t && (t = i ? !1 : 0)),
    ...
    ;(e.effects = { effect: {} }),
        ...
        (e.effects.effect.scale = function (t, i) {
            ...
            ;(n.effect = 'size'),
                ...
                (n.from =
                    t.from ||
                    ('show' === a ? { height: 0, width: 0, outerHeight: 0, outerWidth: 0 } : l)),
                (n.to = {
                    height: l.height * u.y,
                    width: l.width * u.x,
