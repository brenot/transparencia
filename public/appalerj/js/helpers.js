...
function loadData() {
    jQuery.get(app.apiPortal + '/tv', {}, function (result) {
...
function bootAloAlerj() {
    ...
    $('#faleconosco-page').on('swiperight', function () {
        $(':mobile-pagecontainer').pagecontainer('change', 'inicio.html', {
            role: 'page',
            transition: 'slide',
            reverse: 'true',
        })
...
function bootHome() {
    $('#inicio-page').on('click', '.menu-tvalerj', function () {
        $(':mobile-pagecontainer').pagecontainer('change', 'tvalerj.html', {
            role: 'page',
            transition: 'slide',
        })
    ...
    $('#inicio-page').on('click', '.menu-radioalerj', function () {
        $(':mobile-pagecontainer').pagecontainer('change', 'radioalerj.html', {
            role: 'page',
            transition: 'slide',
        })
    ...
    $('#inicio-page').on('click', '.menu-deputado', function () {
        ...
        $(':mobile-pagecontainer').pagecontainer('change', 'deputados.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#inicio-page').on('click', '.menu-mesadiretora', function () {
        ...
        $(':mobile-pagecontainer').pagecontainer('change', 'mesadiretora.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#inicio-page').on('click', '.menu-linhadireta', function () {
        ...
        $(':mobile-pagecontainer').pagecontainer('change', 'linhadireta.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#inicio-page').on('click', '.menu-partidos', function () {
        ...
        $(':mobile-pagecontainer').pagecontainer('change', 'partidos.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#inicio-page').on('click', '.menu-ordem', function () {
        ...
        $(':mobile-pagecontainer').pagecontainer('change', 'ordemdodia.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#inicio-page').on('click', '.menu-regimento', function () {
        ...
        $(':mobile-pagecontainer').pagecontainer('change', 'regimentointerno.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#inicio-page').on('click', '.menu-noticias', function () {
        $(':mobile-pagecontainer').pagecontainer('change', 'noticias.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#inicio-page').on('click', '.menu-aloalerj', function () {
        $(':mobile-pagecontainer').pagecontainer('change', 'faleconosco.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#inicio-page').on('click', '.menu-agenda', function () {
        ...
        $(':mobile-pagecontainer').pagecontainer('change', 'agenda.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#inicio-page').on('click', '.menu-transparencia', function () {
        $(':mobile-pagecontainer').pagecontainer('change', 'transparencia.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#inicio-page').on('click', '.menu-leiseprojetos', function () {
        $(':mobile-pagecontainer').pagecontainer('change', 'leiseprojetos.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#inicio-page').on('click', '.menu-portal', function () {
        $(':mobile-pagecontainer').pagecontainer('change', 'portal.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#inicio-page').on('click', '.menu-carteirada', function () {
        $(':mobile-pagecontainer').pagecontainer('change', 'carteiradadobem.html', {
            role: 'page',
            transition: 'slide',
        })
    })
...
function bootComissoes() {
    ...
    $('#comissoes-page').on('click', '.menu-comissoes-oquesao', function () {
        ...
        $(':mobile-pagecontainer').pagecontainer('change', 'comissoes-oquesao.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#comissoes-page').on('click', '.menu-comissoes-permanentes', function () {
        $(':mobile-pagecontainer').pagecontainer('change', 'comissoes-permanentes.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#comissoes-page').on('click', '.menu-comissoes-cpi', function () {
        $(':mobile-pagecontainer').pagecontainer('change', 'comissoes-cpi.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#comissoes-page').on('click', '.menu-comissoes-especiais', function () {
        $(':mobile-pagecontainer').pagecontainer('change', 'comissoes-especiais.html', {
            role: 'page',
            transition: 'slide',
        })
    })
    ...
    $('#comissoes-page').on('click', '.menu-comissoes-representacao', function () {
        $(':mobile-pagecontainer').pagecontainer('change', 'comissoes-representacao.html', {
            role: 'page',
            transition: 'slide',
        })
    })
