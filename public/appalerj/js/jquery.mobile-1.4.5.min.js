    ...
    !(function (a) {
                            ...
                            return (
                                a.each(f, function () {
                                    ;(c -= parseFloat(a.css(b, 'padding' + this)) || 0),
                                        d &&
                                            (c -=
                                                parseFloat(a.css(b, 'border' + this + 'Width')) ||
                                                0),
        ...
        (function (a) {
            ...
            a.widget('mobile.loader', {
                ...
                defaultHtml:
                    "<div class='" + b + "'><span class='ui-icon-loading'></span><h1></h1></div>",
                                ...
                                ;(i.start = function () {
                                    ...
                                    (m = function (c, d) {
                                        ...
                                        c !== d &&
                                            ...
                                            f &&
                                                e.write(
                                                    '<script>document.domain="' + f + '"</script>',
                                                ),
                                            e.close(),
                                            (b.location.hash = c))
                                    })
            ...
            ;(a.mobile.path = d = {
                    ...
                    return (
                        d.isEmbeddedPage(e)
                            ...
                            : d.isSameDomain(e, this.documentBase) &&
                              (c = e.hrefNoHash.replace(this.documentBase.domain, '').split(f)[0]),
                ...
                squash: function (a, b) {
                    ...
                    return (
                        ...
                        i
                            ? ((d.isPath(k) || 0 === k.replace('#', '').indexOf(this.uiStateKey)) &&
                                  (k = ''),
                            ...
                            e.pathname + e.search === c.pathname + c.search
                                ...
                                ? ((g = d.parseUrl(b)),
                                  (f =
                                      g.pathname +
                                      g.search +
                                      (d.isPreservableHash(g.hash) ? g.hash.replace('#', '') : '')))
                                : (f = a),
                            f
                        )
                    },
                    ...
                    handleSwipe: function (b, c, d, f) {
                        if (
                            ...
                            return (
                                ...
                                e(d, g, a.Event(g, { target: f, swipestart: b, swipestop: c }), !0),
                                !0
                            )
                        }
                        return !1
                                ...
                                if (!a.event.special.swipe.eventInProgress) {
                                    ...
                                    ;(e.move = function (b) {
                                        g &&
                                            ...
                                            i ||
                                                ((i = a.event.special.swipe.handleSwipe(
                                                    g,
                                                    d,
                                                    c,
                                                    h,
        ...
        (function (a) {
            var b = a('head').children('base'),
                c = {
                    element: b.length
                        ? b
                        : a('<base>', { href: a.mobile.path.documentBase.hrefNoHash }).prependTo(
                              a('head'),
                          ),
                    linkSelector:
                ...
                a.widget('mobile.page', {
                    ...
                    _enhance: function () {
                        var c = 'data-' + a.mobile.ns,
                            d = this
                        this.options.role &&
                            this.element.attr('data-' + a.mobile.ns + 'role', this.options.role),
                            this.element
                                .attr('tabindex', '0')
            ...
            a.widget('mobile.pagecontainer', {
                    ...
                    ;(b.originalEvent && b.originalEvent.isDefaultPrevented()) ||
                        ((d =
                            b.originalEvent.type.indexOf('hashchange') > -1
                                ...
                                : c.state.url),
                        d || (d = this._getHash()),
                        (d && '#' !== d && 0 !== d.indexOf('#' + a.mobile.path.uiStateKey)) ||
                            (d = location.href),
                ...
                go: function (c) {
                    if (a.mobile.hashListeningEnabled) b.history.go(c)
                        ...
                        ;(a.mobile.navigate.history.activeIndex = e),
                            ...
                            this.change(f, { direction: g, changeHash: !1, fromHashChange: !0 })
                    }
                },
                    ...
                    return (
                        ...
                        b &&
                            ...
                            (b = a.mobile.path.isPath(b)
                                ? b
                                : a.mobile.path.makeUrlAbsolute('#' + b, this._getDocumentBase()))),
                ...
                _loadSuccess: function (b, c, e, f) {
                    ...
                    return a.proxy(function (h, i, j) {
                        ...
                        l.test(h) &&
                            ...
                            (c.content = k),
                            (c.toPage = k),
                            this._triggerWithDeprecated('load', c).event.isDefaultPrevented() ||
                                (this._isRewritableBaseTag() && k && this._getBase().rewrite(g, k),
                                this._include(k, e),
                ...
                _triggerPageBeforeChange: function (b, c, d) {
                    ...
                    return (
                        ...
                        e.event.isDefaultPrevented() || e.deprecatedEvent.isDefaultPrevented()
                            ? !1
                            : !0
                    )
                },
        ...
        (function (a, b) {
            ;(a.mobile.Transition = function () {
                ...
                a.extend(a.mobile.Transition.prototype, {
                    ...
                    cleanFrom: function () {
                        this.$from
                            .removeClass(a.mobile.activePageClass + ' out in reverse ' + this.name)
                            .height('')
                    },
                    ...
                    scrollPage: function () {
                        ;(a.event.special.scrollstart.enabled = !1),
                            (a.mobile.hideUrlBar || this.toScroll !== a.mobile.defaultHomeScroll) &&
                ...
                _setCloseBtn: function (b, c) {
                    ...
                    ;(b = 'left' === b ? 'left' : 'right' === b ? 'right' : 'none'),
                        'none' === b
                            ? e && (e.remove(), (e = null))
                            : e
                            ? (e.removeClass('ui-btn-left ui-btn-right').addClass('ui-btn-' + b),
                              c && e.text(c))
            ...
            a.widget('mobile.collapsible', {
                    ...
                    ;(this._ui = c),
                        ...
                        this.options.enhanced
                            ? ((c.heading = this.element.children('.ui-collapsible-heading')),
                              ...
                              (c.status = c.anchor.children('.ui-collapsible-heading-status')))
                            : this._enhance(b, c),
                        this._on(c.heading, {
                            tap: function () {
                ...
                _enhance: function (b, c) {
                    ...
                    return (
                        ...
                        c.heading.is('legend') &&
                            ((c.heading = a("<div role='heading'>" + c.heading.html() + '</div>')),
                            (c.placeholder = a(
                    ...
                    a.collapsed !== b && this._handleExpandCollapse(a.collapsed),
                        ...
                        (h =
                            n.collapsedIcon !== b
                                ? n.collapsedIcon !== !1
                                : j.collapsedIcon !== !1),
                        (n.iconpos !== b || n.collapsedIcon !== b || n.expandedIcon !== b) &&
                            (l.removeClass(
                                [d(j.iconpos)]
        ...
        (function (a) {
            ...
            a.mobile.behaviors.addFirstLastClasses = {
                _getVisibles: function (a, c) {
                    var d
                    return (
                        c ? (d = b(a)) : ((d = a.filter(':visible')), 0 === d.length && (d = b(a))),
                        d
                    )
                },
                        ...
                        _hasIcon: function () {
                            ...
                            return d &&
                                ...
                                ? ((c = a.data(b[0], 'mobile-controlgroup')),
                                  'horizontal' !==
                                      (c ? c.options.type : b.attr('data-' + a.mobile.ns + 'type')))
                                : !0
                        },
                        refresh: function () {
                ...
                a.extend(
                    {
                        ...
                        _create: function () {
                            ...
                            p.addClass(v ? 'ui-slider-switch' : 'ui-slider-input'),
                                ...
                                H.bind('vmousedown', a.proxy(this._sliderVMouseDown, this)).bind(
                                    'vclick',
                                    !1,
                                ),
                ...
                a.extend(
                    {
                        ...
                        _dragFirstHandle: function (b) {
                            return (
                                (a.data(this._inputFirst.get(0), 'mobile-slider').dragging = !0),
                        ...
                        _change: function (b) {
                            ...
                            return (
                                ...
                                d === e
                                    ...
                                    : (a.data(h.get(0), 'mobile-slider').handle.css('z-index', ''),
            ...
            a.widget('mobile.textinput', a.mobile.textinput, {
                ...
                _addClearBtn: function () {
                    this.options.enhanced || this._enhanceClear(),
                        a.extend(this, { _clearBtn: this.widget().find('a.ui-input-clear') }),
        ...
        (function (a, c) {
            ...
            a.widget('mobile.popup', {
                ...
                _setOptions: function (a) {
                    ...
                    return (
                        a.wrapperClass !== c &&
                            this._ui.container.removeClass(b.wrapperClass).addClass(a.wrapperClass),
                        a.theme !== c &&
                            d
                ...
                _calculateFinalLocation: function (a, b) {
                    var c,
                        ...
                        f = b.menuSize
                    return (
                        (c = { left: d(e.cx, f.cx, e.x, a.x), top: d(e.cy, f.cy, e.y, a.y) }),
                    ...
                    return (
                        ...
                        this._fallbackTransition)
                            ? void this._ui.container
                                  ...
                                  .animationComplete(a.proxy(b.prerequisites.container, 'resolve'))
            ...
            a.widget('mobile.selectmenu', a.mobile.selectmenu, {
                ...
                build: function () {
                    ...
                    return v.nativeMenu
                        ...
                        : ((c = this.selectId),
                          ...
                          (o = a('<div' + j + l + " id='" + d + "' class='ui-selectmenu'></div>")
                ...
                _decideFormat: function () {
                    ...
                    e > h - 80 || !a.support.scrollTop
                        ...
                        : ((b.menuType = 'overlay'),
                          b.listbox.one({ popupafteropen: a.proxy(this, '_focusMenuItem') }))
                },
                _buildList: function () {
                    var b,
                        d,
                ...
                _destroy: function () {
                    this.options.nativeMenu ||
                        ...
                        this._removePlaceholderAttr &&
                            this._selectOptions().removeAttr('data-' + a.mobile.ns + 'placeholder'),
                        this.listbox.remove(),
        ...
        (function (a, b) {
            ...
            ;(a.fn.buttonMarkup = function (f, i) {
                ...
                for (j = 0; j < this.length; j++) {
                    if (
                        ((l = this[j]),
                        (k = i ? { alreadyEnhanced: !1, unknownClasses: [] } : d(l.className)),
            ...
            a.widget('mobile.toolbar', a.mobile.toolbar, {
                ...
                updatePagePadding: function (c) {
                    ...
                    this.options.fullscreen ||
                        ((c = (c && c.type === b && c) || this.page || d.closest('.ui-page')),
                ...
                _tryAnArrow: function (a, b, c, d, e) {
                    ...
                    return d.arFull[a.dimKey] > d.guideDims[a.dimKey]
                        ...
                        : ((i[a.fst] =
                          ...
                          (!e || h < e.diff) &&
                              ((j[a.snd] -= d.arHalf[a.dimKey] + f[a.prop] + d.contentBox[a.snd]),
                              (e = {
                                  dir: b,
                                  diff: h,
                                  result: f,
        ...
        (function (a, c) {
            a.widget('mobile.panel', {
                ...
                _getPage: function () {
                    var b =
                        this._openedPage || this._parentPage || a('.' + a.mobile.activePageClass)
                    return b
                },
            ...
            a.widget('mobile.filterable', {
                ...
                _filterItems: function (b) {
                    ...
                    0 === i.length
                        ...
                        : (a(i).addClass('ui-screen-hidden'), a(h).removeClass('ui-screen-hidden')),
            ...
            ;(a.mobile.filterable.prototype.options.filterCallback = function (a, b) {
                ...
                a.widget('mobile.filterable', a.mobile.filterable, {
                    ...
                    _create: function () {
                        var b,
                            ...
                            f = {}
                        for (
                            this._super(), a.extend(this, { _widget: null }), b = e.length - 1;
                            b > -1;
                            b--
                        )
                            if (((c = e[b]), a.mobile[c])) {
                    ...
                    _handleCreate: function (a) {
                        this._setWidget(
                            this.element.data('mobile-' + a.type.substring(0, a.type.length - 6)),
                        )
                    },
                        ...
                        if (!b) {
                            ...
                            ;(d = !1),
                                ...
                                a("<form class='ui-filterable'></form>")
                                    ...
                                    .insertBefore(this.element),
                                a.mobile.textinput &&
                                    (null != this.options.filterTheme && (e.theme = c.filterTheme),
                                    b.textinput(e))
                        }
                        this._super(b),
                ...
                a.widget('mobile.listview', a.mobile.listview, {
                    ...
                    refresh: function () {
                        ...
                        this._superApply(arguments),
                            this.options.filter === !0 &&
                                ((a = this.element.data('mobile-filterable')), a && a.refresh())
                    },
                })
        })(a),
        (function (a, b) {
            ...
            a.widget('ui.tabs', {
                ...
                _initialActive: function () {
                    ...
                    return (
                        ...
                        b !== !1 &&
                            ((b = this.tabs.index(this.tabs.eq(b))), -1 === b && (b = c ? !1 : 0)),
                ...
                a.mobile.gradeA() &&
                    ...
                    a(function () {
                        a.support.inlineSVG(),
                            ...
                            (a.mobile.defaultHomeScroll =
                                a.support.scrollTop && 1 !== a.mobile.window.scrollTop() ? 1 : 0),
